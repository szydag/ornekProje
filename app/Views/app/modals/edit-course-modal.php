        ...
        <div class="kt-modal-body p-5">
            ...
            <form id="editCourseForm" class="space-y-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        <input type="text" name="course_name" class="kt-input" placeholder="Kurs adını girin"
                            id="edit_course_name-input" />
                        <div class="text-red-500 text-sm italic mt-1" id="edit_course_name-error"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        <textarea name="course_description" class="kt-textarea" placeholder="Kurs açıklamasını girin"
                            rows="4" id="edit_course_description-input"></textarea>
                        <div class="text-red-500 text-sm italic mt-1" id="edit_course_description-error"
                            style="display: none;"></div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        ...
                        <div class="text-red-500 text-sm italic mt-1" id="edit_start_date-error" style="display: none;">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="checkbox" name="unlimited" id="edit_unlimited-checkbox"
                        ...
                        <div class="text-red-500 text-sm italic mt-1" id="edit_end_date-error" style="display: none;">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        ...
                        <div class="text-red-500 text-sm italic mt-1" id="edit_manager-error" style="display: none;">
                        </div>
                    </div>
                </div>
            </form>
...
<script>
    ...
    function saveEditCourse() {
        ...
        // AJAX ile güncelle
        fetch(`<?= base_url('admin/api/courses') ?>/${courseId}`, {
            method: 'POST',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json',
